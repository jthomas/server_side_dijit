// "Lite" version of the Dojo parser to support 
// server-side rendering. The following changes has been made...
//
// - Strip out "mixin" support, we use this client-side to override 
// templating.
// - Remove <script> hooks, these don't mean anything server-side.
//

define(
	["dojo/_base/kernel", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/config", "dojo/_base/html", "dojo/_base/window", "dojo/_base/url",
		"dojo/_base/json", "dojo/aspect", "dojo/date/stamp", "dojo/Deferred", "dojo/has", "dojo/query", "dojo/on", "dojo/ready"],
...
//						types = mixinsValue ? [type].concat(mixinsValue.split(/\s*,\s*/)) : [type];
		...
		construct: function(ctor, node, mixin, options, scripts, inherited){
			...
			var i=0, item, funcAttrs=[], jsname, extra, dtype, dmixins;
...
/*			if(!scripts){
            ...
            // Now we need to add the data-dojo-type and data-dojo-props back to the instance
            ...
            // JAMES: We don't need to process any of the JS-land
            // hooks that are registered. Once template is registered, just return.
            /** 
		...
		scan: function(root, options){
			...
			while(true){
				...
				var type = node.getAttribute(dataDojoType) || node.getAttribute(dojoType),
				    mixin = node.getAttribute(dataDojoMixins);
				...
				var ctor = null;
				if(type && mixin && mixin.indexOf("server_side/_Templated") >= 0){
